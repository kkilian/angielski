...
| Wracam do Polski na stałe i mam co do tego mieszane uczucia. | I'm heading back to Poland for good, and I've got mixed feelings about it. |
...
| Mam mieszane uczucia: wrócić do rodziców czy wynająć coś u siebie. | I've got mixed feelings — move back in with my parents or rent my own place. |
| Wciąż się waham, ale skoro wracam na dobre, muszę gdzieś zamieszkać. | I'm still on the fence, but since I'm heading back for good, I've got to live somewhere. |
| Powiedziałem Jake'owi, że domykam robotę, wracam na stałe i waham się co do mieszkania. | I told Jake I'm wrapping up, heading back for good, and on the fence about where to live. |
| Najdziwniejsze jest to, że wracam na stałe, a wciąż nie wiem, gdzie zamieszkam. | The strangest part is that I'm heading back for good and still don't know where I'll live. |
...
**Wymowa (pułapki):**
- **fence** /fens/ — rymuje się z „sense / tense"; „e" jak w „bed" + bezdźwięczne „s". Nie „fejns", nie „fenz".
- **parents** /ˈper.ənts/ — akcent na 1. sylabę: *PA-rents*, nie „pa-RENTS".
- **mixed** /mɪkst/ — „-ed" po /k/ brzmi jak słyszalne „t", ale BEZ dodatkowej sylaby: „mikst", nie „mik-sed".

**Typowe błędy Polaka:**
- *on the fence* WYMAGA „the" — nie *on fence*. Idiom jest sztywny.
- „mieszane uczucia" to *mixed feelings* (l. mnoga, bez „the"); nie *mixed feeling*.
- „wprowadzić się do rodziców" → zawsze *with my/your parents* (konkret), nigdy *with someone*.
- *folks* = „starzy/rodzice" (luźno), nie „ludzie" w tym kontekście.
